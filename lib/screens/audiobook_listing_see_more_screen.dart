...
class AudioBooksListScreen extends ConsumerWidget { // Change to ConsumerWidget
  final List<Booksdata> audioBooks;
  final String category;

  const AudioBooksListScreen({super.key, required this.audioBooks, required this.category});
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return Books(book: audioBooks[index].toMap(), typeed: "audio");
          },
        ),
      ),
    );
